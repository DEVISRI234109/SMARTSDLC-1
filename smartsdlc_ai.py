...
Original file is located at
    https://colab.research.google.com/drive/1vf4xIOdpjuFTwYc7vzKMZEIxg1dt-FJ4
"""
...
def policy_summarization(pdf_file, prompt_text):
    # Get text from PDF or direct input
    if pdf_file is not None:
        content = extract_text_from_pdf(pdf_file)
        summary_prompt = f"summarize the following policy document and extract the most important points, key provisions, and imlications:\n\n{content}"
    else:
        summary_prompt = f"summarize the following policy document and extract the most important points, key provisions, and imlications:\n\n{prompt_text}"
...
def eco_tips_generator(problem_keywords):
    prompt = f"Generate practical and actionable eco-friendly tips sustainable living related to:{problem_keywords}.provide specific solution and suggestions:"
            ...
            with gr.Row():
                with gr.Column():
                    keywords_input = gr.Textbox(
                        label="Enviromental Problem/Keywords",
